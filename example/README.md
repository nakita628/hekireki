...
This builds the generators, wipes `generated/`, runs `prisma generate`, and verifies that all 23 outputs exist — printing a ✓/✗ table and exiting non-zero if any generator produced nothing.
