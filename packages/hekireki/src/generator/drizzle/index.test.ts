...
describe('drizzleSchema - SNS full schema (self-referencing + composite PK + indexes + enum)', () => {
  ...
  const snsIndexes: DMMF.Index[] = [
    { model: 'Post', type: 'normal', isDefinedOnField: false, fields: [{ name: 'userId' }, { name: 'createdAt' }], dbName: 'Post_userId_createdAt_idx' },
    { model: 'PostImage', type: 'normal', isDefinedOnField: false, fields: [{ name: 'postId' }, { name: 'sortOrder' }], dbName: 'PostImage_postId_sortOrder_idx' },
    { model: 'Like', type: 'normal', isDefinedOnField: false, fields: [{ name: 'postId' }], dbName: 'Like_postId_idx' },
    { model: 'Follow', type: 'normal', isDefinedOnField: false, fields: [{ name: 'followingId' }], dbName: 'Follow_followingId_idx' },
    { model: 'Follow', type: 'normal', isDefinedOnField: false, fields: [{ name: 'followerId' }], dbName: 'Follow_followerId_idx' },
    { model: 'Comment', type: 'normal', isDefinedOnField: false, fields: [{ name: 'postId' }, { name: 'createdAt' }], dbName: 'Comment_postId_createdAt_idx' },
    { model: 'Notification', type: 'normal', isDefinedOnField: false, fields: [{ name: 'userId' }, { name: 'read' }, { name: 'createdAt' }], dbName: 'Notification_userId_read_createdAt_idx' },
  ]
  ...
  const snsModels: DMMF.Model[] = [
    makeModel({
      name: 'User',
      fields: [
        makeField({ name: 'id', type: 'String', isId: true, hasDefaultValue: true, default: { name: 'uuid', args: [] } }),
        makeField({ name: 'createdAt', type: 'DateTime', hasDefaultValue: true, default: { name: 'now', args: [] } }),
        makeField({ name: 'deletedAt', type: 'DateTime', isRequired: false }),
        // relations
        makeField({ name: 'personalInformation', type: 'UserPersonalInformation', kind: 'object', isRequired: false }),
        makeField({ name: 'loginPassword', type: 'UserLoginPassword', kind: 'object', isRequired: false }),
        ...
        makeField({ name: 'followers', type: 'Follow', kind: 'object', isList: true, isRequired: false, relationName: 'Following' }),
        makeField({ name: 'following', type: 'Follow', kind: 'object', isList: true, isRequired: false, relationName: 'Follower' }),
        makeField({ name: 'comments', type: 'Comment', kind: 'object', isList: true, isRequired: false }),
        makeField({ name: 'notifications', type: 'Notification', kind: 'object', isList: true, isRequired: false, relationName: 'NotificationTo' }),
        makeField({ name: 'sentNotifications', type: 'Notification', kind: 'object', isList: true, isRequired: false, relationName: 'NotificationFrom' }),
        makeField({ name: 'mediaObjects', type: 'MediaObject', kind: 'object', isList: true, isRequired: false }),
      ],
    }),
    makeModel({
      ...
      fields: [
        ...
        // relations
        makeField({ name: 'user', type: 'User', kind: 'object', relationFromFields: ['userId'], relationToFields: ['id'], relationOnDelete: 'Cascade' }),
        makeField({ name: 'profileImage', type: 'MediaObject', kind: 'object', isRequired: false, relationName: 'ProfileImage', relationFromFields: ['profileImageId'], relationToFields: ['id'] }),
        makeField({ name: 'coverImage', type: 'MediaObject', kind: 'object', isRequired: false, relationName: 'CoverImage', relationFromFields: ['coverImageId'], relationToFields: ['id'] }),
      ],
    }),
    makeModel({
    ...
    makeModel({
      ...
      fields: [
        ...
        makeField({ name: 'repostOf', type: 'Post', kind: 'object', isRequired: false, relationName: 'Repost', relationFromFields: ['repostOfId'], relationToFields: ['id'] }),
        makeField({ name: 'reposts', type: 'Post', kind: 'object', isList: true, isRequired: false, relationName: 'Repost' }),
        // Normal relations
        makeField({ name: 'user', type: 'User', kind: 'object', relationFromFields: ['userId'], relationToFields: ['id'], relationOnDelete: 'Cascade' }),
        makeField({ name: 'images', type: 'PostImage', kind: 'object', isList: true, isRequired: false }),
        makeField({ name: 'likes', type: 'Like', kind: 'object', isList: true, isRequired: false }),
        makeField({ name: 'comments', type: 'Comment', kind: 'object', isList: true, isRequired: false }),
      ],
    }),
    makeModel({
      ...
      fields: [
        ...
        makeField({ name: 'status', type: 'ImageStatus', kind: 'enum', hasDefaultValue: true, default: 'PENDING' }),
        makeField({ name: 'uploadedBy', type: 'String' }),
        makeField({ name: 'createdAt', type: 'DateTime', hasDefaultValue: true, default: { name: 'now', args: [] } }),
        // relations
        makeField({ name: 'uploader', type: 'User', kind: 'object', relationFromFields: ['uploadedBy'], relationToFields: ['id'] }),
        makeField({ name: 'profileUser', type: 'UserPersonalInformation', kind: 'object', isRequired: false, relationName: 'ProfileImage' }),
        makeField({ name: 'coverUser', type: 'UserPersonalInformation', kind: 'object', isRequired: false, relationName: 'CoverImage' }),
        makeField({ name: 'postImages', type: 'PostImage', kind: 'object', isList: true, isRequired: false }),
      ],
    }),
    makeModel({
      name: 'PostImage',
      ...
      fields: [
        ...
        makeField({ name: 'post', type: 'Post', kind: 'object', relationFromFields: ['postId'], relationToFields: ['id'], relationOnDelete: 'Cascade' }),
        makeField({ name: 'media', type: 'MediaObject', kind: 'object', relationFromFields: ['mediaId'], relationToFields: ['id'] }),
      ],
    }),
    makeModel({
      name: 'Like',
    ...
    makeModel({
      ...
      fields: [
        ...
        makeField({ name: 'createdAt', type: 'DateTime', hasDefaultValue: true, default: { name: 'now', args: [] } }),
        makeField({ name: 'follower', type: 'User', kind: 'object', relationName: 'Follower', relationFromFields: ['followerId'], relationToFields: ['id'], relationOnDelete: 'Cascade' }),
        makeField({ name: 'following', type: 'User', kind: 'object', relationName: 'Following', relationFromFields: ['followingId'], relationToFields: ['id'], relationOnDelete: 'Cascade' }),
      ],
    }),
    makeModel({
      name: 'Comment',
    ...
    makeModel({
      ...
      fields: [
        ...
        makeField({ name: 'createdAt', type: 'DateTime', hasDefaultValue: true, default: { name: 'now', args: [] } }),
        makeField({ name: 'from', type: 'User', kind: 'object', relationName: 'NotificationFrom', relationFromFields: ['fromUserId'], relationToFields: ['id'], relationOnDelete: 'Cascade' }),
        makeField({ name: 'user', type: 'User', kind: 'object', relationName: 'NotificationTo', relationFromFields: ['userId'], relationToFields: ['id'], relationOnDelete: 'Cascade' }),
      ],
    }),
  ]
