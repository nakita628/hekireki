  ...
  it('publishes the OpenAPI document', async () => {
    ...
    expect(new Set(paths)).toStrictEqual(
      new Set([
        ...
        '/api/migrate/apply',
        '/api/migrate/backups',
        '/api/migrate/backups/restore',
        '/api/migrate/baseline',
        '/api/migrate/decisions',
        '/api/migrate/deploy',
        '/api/migrate/diff',
        '/api/migrate/migrations',
        '/api/migrate/migrations/{migrationName}',
        '/api/migrate/migrations/applied',
        '/api/migrate/migrations/rolled-back',
        '/api/migrate/plan',
        '/api/migrate/rehearse',
        '/api/migrate/tables',
