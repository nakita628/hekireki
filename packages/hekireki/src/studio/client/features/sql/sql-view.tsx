...
export function SqlView() {
  ...
  return (
    <section className="grid min-h-0 flex-1 grid-cols-[minmax(0,1fr)_minmax(340px,42%)] overflow-hidden">
      <div className="flex min-h-0 min-w-0 flex-col border-r border-line">
        ...
        <div className="grid min-h-0 flex-1 grid-rows-[minmax(140px,40%)_minmax(0,1fr)]">
