...
const groupByModelHelperTestCases = [
  {
    validFields: [
      ...
      },
      {
        ...
        modelName: 'User',
        fieldName: 'bio',
        comment: ["User's biography or profile description", '@v.optional(v.string(), "")'],
      ...
      },
      {
        ...
        modelName: 'User',
        fieldName: 'email',
        comment: ["User's unique email address", '@v.pipe(v.string(), v.email())'],
      ...
      },
      {
        ...
        modelName: 'User',
        fieldName: 'image',
        comment: ["URL of user's image", '@v.optional(v.pipe(v.string(), v.url()))'],
      ...
      },
      {
        ...
        comment: ["URL of user's cover image", '@v.optional(v.pipe(v.string(), v.url()))'],
        validation: 'string().url().optional()',
      },
      {
        documentation:
        ...
        comment: ["URL of user's profile image", '@v.optional(v.pipe(v.string(), v.url()))'],
        validation: 'string().url().optional()',
      },
      {
        documentation:
      ...
      },
      {
        ...
        modelName: 'Post',
        fieldName: 'body',
        comment: ['Content of the post', '@v.pipe(v.string(), v.minLength(1), v.maxLength(1000))'],
      ...
      },
      {
        ...
        modelName: 'Follow',
        fieldName: 'id',
        comment: ['Unique identifier for the follow relationship', '@v.pipe(v.string(), v.uuid())'],
        validation: 'string().uuid()',
      },
      {
        documentation: '',
        ...
        comment: ['ID of the user who is following', '@v.pipe(v.string(), v.uuid())'],
        validation: 'string().uuid()',
      },
      {
        documentation: '',
        ...
        comment: ['ID of the user being followed', '@v.pipe(v.string(), v.uuid())'],
        validation: 'string().uuid()',
      },
      {
        documentation: '',
        modelName: 'Follow',
        fieldName: 'createdAt',
        comment: ['Timestamp when the follow relationship was created', '@v.date()'],
        validation: 'date()',
      },
      {
        documentation: '',
      ...
      },
      {
        ...
        modelName: 'Like',
        fieldName: 'postId',
        comment: ['ID of the post that was liked', '@v.pipe(v.string(), v.uuid())'],
        validation: 'string().uuid()',
      },
      {
        documentation: '',
      ...
      },
      {
        ...
        modelName: 'Comment',
        fieldName: 'id',
        comment: ['Unique identifier for the comment', '@v.pipe(v.string(), v.uuid())'],
        validation: 'string().uuid()',
      },
      {
        documentation: '',
      ...
      },
      {
        ...
        modelName: 'Comment',
        fieldName: 'userId',
        comment: ['ID of the user who created the comment', '@v.pipe(v.string(), v.uuid())'],
        validation: 'string().uuid()',
      },
      {
        documentation: '',
        modelName: 'Comment',
        fieldName: 'postId',
        comment: ['ID of the post this comment belongs to', '@v.pipe(v.string(), v.uuid())'],
        validation: 'string().uuid()',
      },
      {
        documentation: '',
        ...
        fieldName: 'id',
        comment: ['Unique identifier for the notification', '@v.pipe(v.string(), v.uuid())'],
        validation: 'string().uuid()',
      },
      {
        documentation: '',
      ...
      },
      {
        ...
        modelName: 'Notification',
        fieldName: 'userId',
        comment: ['ID of the user who receives the notification', '@v.pipe(v.string(), v.uuid())'],
        validation: 'string().uuid()',
      },
      {
        documentation: '',
